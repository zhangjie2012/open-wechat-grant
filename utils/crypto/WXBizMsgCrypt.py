...
import utils.crypto.ierror as ierror
...
class PKCS7Encoder:
    ...
    def encode(self, text):
        ...
        text = text + bytes(pad * amount_to_pad, 'utf-8')
        return text
...
class Prpcrypt(object):
    ...
    def encrypt(self, text, appid):
        ...
        try:
            ...
            return ierror.WXBizMsgCrypt_OK, base64.b64encode(cipher_text).decode('utf-8')
        except Exception as e:
...
class WXBizMsgCrypt(object):
    ...
    def __init__(self, s_token, s_encoding_aes_key, s_app_id):
        try:
            ...
            throw_exception("[error]: EncodingAESKey unavail !", FormatException)
